...
class ReportCard : AppCompatActivity() {
        ...
        with(binding) {
            ...
            buttonSubmit.setOnClickListener {
                ...
                if (validateFormInput())
                {
                    ...
                    textFieldReportLocation.editText?.text?.clear()
                    ...
                    findNavController(this@ReportCard, R.id.fragment_container_view)
                        .navigate(R.id.fragment_home)

                } else {
                    showSnackBar(getString(R.string.fill_all))
                }
    ...
    private fun restoreUiState() =
        with(binding) {
            ...
            datePicker.editText?.setText(viewModel.date)
    ...
    private fun validateFormInput(): Boolean {
        ...
        with(binding) {
            ...
            if (viewModel.date.isEmpty()) {
                textFieldReportDate.error = getString(R.string.date_empty)
                isValid = false
            } else {
            ...
            if (viewModel.type.isEmpty()) {
                autoCompleteReportType.error = getString(R.string.type_empty)
                isValid = false
            } else {
            ...
            if (viewModel.severity.isEmpty()) {
                textSeverityError.error = getString(R.string.select_severity)
