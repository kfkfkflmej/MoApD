...
class SettingsActivity : ComponentActivity() {
    ...
    /**
     * Defines the Settings Activity.
     * The activity sets the main parts of the UI and handles the user's settings.
     * Written by me with help from AI for saving a profile picture.
     */
