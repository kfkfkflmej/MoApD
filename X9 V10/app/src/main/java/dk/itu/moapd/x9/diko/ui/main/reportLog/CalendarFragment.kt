...
class CalendarFragment : Fragment(R.layout.fragment_report_calendar) {
    /**
     * Defines the Report Calendar Tab.
     * Displays a calendar and allow the user to select a date and calls a bottom sheet to display
     * a list of all submitted reports on the selected date.
